...
Age_of_Store = st.number_input("Store Age (Years)", min_value=0, value=16)
Product_Category = st.selectbox("Product Type Category", ["edibles", "non-edibles"])
...
if st.button("Predict", type='primary'):
    ...
    if response.status_code == 200:
        ...
        predicted_sales = result["Sales Prediction"]
